...
copy the bitmap data to the dispay buffer.
...
When a line has been copied by DMA a DMA end interrupt is generated.
This updates the destination address to the next line in the display
buffer and the next DMA transfer is initiated by software. All sub-
sequent transfers are software initiated.
