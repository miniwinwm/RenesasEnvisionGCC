...
#define	CS_H();		sci2_spi_chip_select(1U);	/* Set MMC CS "high" */
#define CS_L();		sci2_spi_chip_select(0U);	/* Set MMC CS "low" */
...
{
	sci2_spi_send_receive(buff, NULL, bc);
}
...
{
	sci2_spi_send_receive(NULL, buff, bc);
}
